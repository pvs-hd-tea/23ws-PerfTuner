...
def transformBySnippet(function_filepath, snippet_filepath, snippet_opt_filepath):
    ...
    response = client.chat.completions.create(
        ...
        Make a list of the main sub tasks of the function."},
    ...
    response = client.chat.completions.create(
        ...
        temperature=1.0,
        messages=[
        {"role": "user", "content": "Which sub task of the following list can be optimized by using AVX intrinsics?"},
    ...
    response = client.chat.completions.create(
        ...
        {"role": "user", "content": "function: " + function},
        {"role": "user", "content": "Make a list of the main sub tasks of the function."},
